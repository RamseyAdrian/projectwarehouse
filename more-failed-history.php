                ...
                <div class="box">
                    <table border="1" cellspacing="0" class="table">
                        ...
                        <tbody>
                            ...
                            $trans = mysqli_query($conn, "SELECT * FROM data_order WHERE data_order.status = 'Gagal Diambil' OR data_order.status = 'Tidak Disetujui Admin' $where ORDER BY times_updated DESC");
                            while ($fo_trans = mysqli_fetch_assoc($trans)) {
                            ?>
                                <tr>
                                    <td><?php echo $no++ ?></td>
