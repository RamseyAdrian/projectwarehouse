...
<body>
    ...
    ?>
        ...
        <div class="section">
            <div class="container">
                <h2>Edit Jumlah Pengambilan Barang</h2>
                <div class="box">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <?php
                                $no++;
                                $order_id = $fo_trans->order_id;
                            }
                        }
                        ?>
                        <button id="button-restock"><a href="delete-data.php?idpd=<?php echo $order_id ?>">Hapus Barang</a></button>
                        <br><br>
                        <center>
